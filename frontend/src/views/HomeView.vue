...
.welcome-status-badge {
  ...
  &--connected {
    background: linear-gradient(135deg, var(--color-secondary-light) 0%, rgba(209, 250, 229, 0.8) 100%);
  ...
  &--demo {
    ...
    &:hover {
      background: linear-gradient(135deg, rgba(253, 230, 138, 0.95) 0%, rgba(252, 211, 77, 0.8) 100%);
