      ...
      <div v-if="!currentChat" class="welcome-screen">
        <div class="welcome-content">
          ...
          <p class="welcome-description">
            Ask questions about your business data in natural language and get insights instantly.
          </p>
        ...
        <div class="chat-header">
          ...
          <div class="connection-status">
            ...
            <div 
              ...
              :title="connectionMessage || 'Demo mode - start backend for real queries'"
              @click="testConnection"
              style="cursor: pointer;"
            >
              <div class="status-dot"></div>
        ...
        <div ref="messagesContainer" class="messages-container">
          <div v-if="currentChat.messages.length === 0" class="empty-chat">
            <div class="empty-chat__content">
              ...
              <p>Ask me anything about your business data and I'll provide the insights you need.</p>
...
const connectionStatus = ref<'unknown' | 'checking' | 'connected' | 'disconnected'>('unknown')
...
const sendMessage = async (content: string) => {
  ...
  try {
    ...
    // Stream response
    const stream = chatService.streamChat(currentChat.value.messages.slice(0, -1).concat([userMessage]))
...
const testConnection = async () => {
  ...
  try {
    ...
    console.log(result.isConnected ? 'Backend connected successfully' : `Backend connection failed: ${result.status}`)
  } catch (error) {
